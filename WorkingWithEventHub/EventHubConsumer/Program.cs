...
namespace EventHubConsumer
{
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            _storageClient = new BlobContainerClient(_blobStorageConnectionString, _blobContainerName);

            // Create an event processor client to process events in the event hub
            _processor = new EventProcessorClient(_storageClient, consumerGroup, _eventHubConnectionString, _eventHubName);
